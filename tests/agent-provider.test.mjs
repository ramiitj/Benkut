...
test('agent provider validates and returns structured provider JSON',async()=>{
  ...
  globalThis.fetch=async()=>({ok:true,json:async()=>({candidates:[{content:{parts:[{text:JSON.stringify({language:'en',speech:'What did you eat?',intent:'meal',workspace:{title:'Meal',body:'Tell me what you ate.'},action:null,confirmationRequired:false,suggestions:[]})}]}}]})});
